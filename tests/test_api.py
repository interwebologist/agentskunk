        ...
        resp = requests.post(
            ...
            json={
                ...
                "messages": [
                    ...
                    {
                        "role": "user",
                        "content": "Read the AGENTS.md file and tell me what it contains.",
                    },
                ],
                "temperature": 0.7,
            },
        ...
        resp = requests.post(
            ...
            json={
                ...
                "messages": [
                    ...
                    {
                        "role": "user",
                        "content": "Search the web for 'python programming'",
                    },
                ],
                "temperature": 0.7,
            },
        ...
        resp = requests.post(
            ...
            json={
                ...
                "messages": [
                    ...
                    {
                        "role": "user",
                        "content": "Fetch https://example.com and tell me what it contains.",
                    },
                ],
                "temperature": 0.7,
            },
